...
col1.metric("Workouts", num_of_workouts, delta=None, delta_color="normal", help=None, label_visibility="visible")
col2.metric("Average Workout Time", average_time_formatted, delta=None, delta_color="normal", help=None, label_visibility="visible")
col3.metric("Average Number Of Exercises Per Workout", average_exercises, delta=None, delta_color="normal", help=None, label_visibility="visible")
col4.metric("Average Number Of Sets Per Exercise", average_sets, delta=None, delta_color="normal", help=None, label_visibility="visible")
...
st.line_chart(grouped_workouts[['num_exercises', 'start_time' ,'year']], 
